...
const Business = () => {
  ...
  return (
    <MoPadding>
      ...
      >
        <img src="/img/businessImg1.png" alt="businessImg1" width={'100%'} />
        <Spacer space={30} />
        <div
          style={{
            display: 'flex',
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <img src="/img/businessIcon1.svg" alt="businessIcon1" width={15} />
            <Spacer vertical={false} space={10} />
            <Typography
              fontSize={14}
              fontWeight="500"
              color="#fff"
              addStyle={{ lineHeight: 1.2 }}
            >
              전문가 멘토님들을 위한 부업입니다.{' '}
      ...
      <Spacer space={20} />
      <Typography fontSize={12} addStyle={{ lineHeight: 1.4 }}>
